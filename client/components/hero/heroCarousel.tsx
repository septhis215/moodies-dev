  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-end w-full gap-6">
          ...
          <div className="flex-1 text-white relative z-10 max-w-3xl">
            ...
            <div className="mt-6 flex flex-wrap gap-4">
              {/* Primary CTA */}
              <button
                className="px-[clamp(1rem,2.5vw,1.75rem)] py-[clamp(0.5rem,1vw,0.9rem)] 
      ...
      hover:from-red-700 hover:to-pink-700 transition-all duration-200"
              >
                <span className="flex items-center gap-2">
                  <IconInfoCircle className="w-5 h-5 text-white-500" /> More
                  Info
                </span>
              </button>
      ...
      transition-all duration-200"
              >
                <span className="flex items-center gap-2">
                  <IconPlus className="w-5 h-5 text-white-500" /> 
                    My List
                </span>
              </button>
            </div>
